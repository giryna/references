...
public class ReflectionExample {
    public static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchFieldException {
        ...
        final Method[] allMethods = rental.getMethods();
        ...
        final Method[] declaredMethods = rental.getDeclaredMethods();
        ...
        final Method oneMethod = rental.getMethod("computeRentalCost", new Class[]{Integer.TYPE});
        ...
        final Class[] parameterTypes = oneMethod.getParameterTypes();
        ...
        final Class returnType = oneMethod.getReturnType();
        System.out.println("Return type is: " + returnType);

        // gets all the public member fields of the class RentCar
        final Field[] fields = rental.getFields();
        ...
        final Field privateField = RentCar.class.getDeclaredField("type");

        final String name = privateField.getName();
        ...
        final String fieldValue = (String) privateField.get(rent);
